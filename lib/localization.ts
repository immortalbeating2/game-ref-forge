...
const copy = {
  zh: {
    ...
    scoreProfile: "评分画像",
    safetyScore: "安全性",
    scoreProfileIncomplete: "补全五项评分后可查看画像。",
    tagAxes: "标签轴",
    ...
    densityControl: "参考卡密度",
    searchShortcut: "按 / 聚焦搜索",
    collapseComparisonDock: "收起对比坞",
    expandComparisonDock: "展开对比坞",
    removeFromComparison: "从对比中移除",
    comparisonSelectionHint: "按对比顺序点击参考卡加入",
    comparisonNeedsMore: "至少再选择 {count} 条参考",
    comparisonPersistedOnly: "示例可用于对比探索；保存至少两条参考后才能进入综合稿。",
    inspirationExtraction: "灵感提炼",
    reusablePrinciples: "可复用原则",
    transformationDirection: "转化方向",
  ...
  en: {
    ...
    safetyScore: "Safety",
    scoreProfileIncomplete: "Complete all five scores to view the profile.",
    tagAxes: "Tag axes",
    ...
    densityControl: "Reference card density",
    searchShortcut: "Press / to focus search",
    collapseComparisonDock: "Collapse comparison dock",
    expandComparisonDock: "Expand comparison dock",
    removeFromComparison: "Remove from comparison",
    comparisonSelectionHint: "Click cards to add them in comparison order",
    comparisonNeedsMore: "Select at least {count} more",
    comparisonPersistedOnly: "Examples can be explored in comparison; save at least two references before entering synthesis.",
    inspirationExtraction: "Inspiration extraction",
    reusablePrinciples: "Reusable principles",
