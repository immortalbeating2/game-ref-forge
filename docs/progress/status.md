...
- Task 8 local integration QA is complete. Its historical fixed `380/440px` and `54%/46%` card repair was subsequently rejected by Task 9 independent review because it violated the approved 16:9 preview, natural card height and full-content visibility contracts; those measurements remain in the QA document only as superseded audit evidence.
